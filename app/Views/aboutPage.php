...
<section id="EthicsCompliance">
    ...
    <h3>Ethics Line</h3>
    <p>It is Etihad’s 24 hour global reporting service, operated by an independent company, where you can ask questions
        or raise concerns in confidence about matters of compliance with the Etihad Code of Business Conduct or the law.
    </p>
    <h3>Who can use Ethics Line?</h3>
    <p>Ethics Line is open to all employees, customers and other stakeholders to report their concerns. However, it
        cannot be used to report general customer or other complaints.</p>
    <h3>How can I report a concern via Ethics Line?</h3>
    <p>It's quick and easy to let us know if you have a concern, and you can stay anonymous if you'd prefer. Simply
        visit Ethics Line to submit an online report or raise your concern via phone – all in the language of your
        choice.</p>
</section>
